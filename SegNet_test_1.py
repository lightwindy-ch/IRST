...
# 下载示例图像
# img = Image.open('/home/zwz21/下载/SegNet/DLRSD/train_images/tenniscourt40.png')
img = Image.open('/home/zwz21/下载/SegNet/DLRSD/train_images/sparseresidential42.png')
...
def visualize_segmentation(img, seg_map,seg_map1, out1,out2):
    ...
    plt.figure(figsize=(10, 10))
    plt.imshow(seg_map)
    plt.savefig('f1-2.png')

    plt.figure(figsize=(10, 10))
    plt.imshow(out1)
    plt.savefig('f1-3.png')
